...
import {
  ...
  createUserSchema,
} from '@/features/admin/forms/createUserSchema.js'
        ...
        <Card className="p-6">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <div className="flex items-center gap-2 rounded-sm bg-info-soft px-3 py-2.5 text-xs font-semibold text-info">
                    Password dibuat otomatis — salin &amp; kirim ke user, tidak bisa
                    dilihat lagi
                  </div>
                  <FormMessage />
                </FormItem>
          ...
          <div className="mt-8 flex items-center justify-between border-t border-line pt-5">
            ...
            <Button type="submit" disabled={mutation.isPending}>
              {mutation.isPending ? 'Membuat...' : '+ Buat User'}
            </Button>
          </div>

          <p className="mt-4 text-center text-xs text-ink-3">
            Setelah dibuat, user bisa langsung login dengan username &amp; password
            ini
          </p>
        </Card>
      </form>
