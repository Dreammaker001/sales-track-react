...
import {
  useUpdatePTDatabaseConfig,
  usePTDatabaseConfig,
} from '@/features/admin-pt-database-config/hooks/usePTDatabaseConfig.js'
...
export default function AdminEditPTDatabaseConfigPage() {
  ...
  if (isLoading) {
    return <Card className="p-6 text-sm text-ink-2">Memuat konfigurasi database PT...</Card>
  }

  if (isError || !data) {
    return (
      <Card className="p-6">
        <p className="text-sm font-semibold text-danger">Gagal memuat konfigurasi database PT</p>
