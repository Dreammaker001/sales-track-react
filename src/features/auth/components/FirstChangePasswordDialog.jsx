              ...
              <div>
                <div className="grid grid-cols-4 gap-2 mt-3">
                  {[1, 2, 3, 4].map((level) => (
                    <div
                      key={level}
                      className={`h-2 w-full rounded ${levelPassword >= level ? 'bg-success' : 'bg-(--color-canvas)'}`}
                    ></div>
                  ))}
                ...
                <div className="grid grid-cols-2 gap-4 mt-4">
                  <div>
                    <div className="flex items-center gap-2 mt-2">
                      <div
                        className={`w-5 h-5 rounded-[5px] border ${strongPassword.hasLowerCase ? 'bg-success-soft border-success-soft' : 'bg-transparent border-(--color-canvas)'}`}
                      >
                        {strongPassword.hasLowerCase && (
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <div
                        className={`w-5 h-5 rounded-[5px] border ${strongPassword.hasNumber ? 'bg-success-soft border-success-soft' : 'bg-transparent border-(--color-canvas)'}`}
                      >
                  ...
                  <div>
                    <div className="flex items-center gap-2 mt-2">
                      <div
                        className={`w-5 h-5 rounded-[5px] border ${strongPassword.hasUpperCase ? 'bg-success-soft border-success-soft' : 'bg-transparent border-(--color-canvas)'}`}
                      >
                        {strongPassword.hasUpperCase && (
                          <CheckIcon className="w-4 h-4 text-success" />
                        )}
                      </div>
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <div
                        className={`w-5 h-5 rounded-[5px] border ${strongPassword.hasSpecialChar ? 'bg-success-soft border-success-soft' : 'bg-transparent border-(--color-canvas)'}`}
                      >
                        {strongPassword.hasSpecialChar && (
                          <CheckIcon className="w-4 h-4 text-success" />
                        )}
                      </div>
